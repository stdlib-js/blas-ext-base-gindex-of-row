...
var Q=require('@stdlib/blas-base-assert-is-layout/dist'),U=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),W=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),Y=require('@stdlib/strided-base-stride2offset/dist'),Z=require('@stdlib/math-base-special-fast-max/dist'),F=require('@stdlib/error-tools-fmtprodmsg/dist'),_=j();function $(a,e,n,u,i,m,q){var t,s,f;if(!Q(a))throw new TypeError(F('2W3Fx',a));if(U(a)?f=n:f=e,i<Z(1,f))throw new RangeError(F('2W3IR',f,i));return W(a)?(t=1,s=i):(t=i,s=1),_(e,n,u,t,s,0,m,q,Y(n,q))}P.exports=$
